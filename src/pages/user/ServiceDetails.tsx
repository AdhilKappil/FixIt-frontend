      ...
      <div className="">
            ...
            <div className="mt-5 w-1/2 max-md:w-full grid p-5 justify-center">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="relative w-56 mt-5 bg-white rounded-lg text-primary p-2 px-5 font-semibold"
                >
                  Book This Service
                </button>
              </div>
        ...
        <div className="flex justify-center">
          <div className="w-3/4 max-md:w-full max-md:p-4">
            <div
              className="w-2/3 max-md:w-full shadow-lg bg-white mt-10 rounded-lg p-5"
              data-aos="fade-up"
            >
              ...
              <p className="text-sm text-gray-500 mt-2">
                Please note that our billing structure is based on hourly rates.
                The initial charge for the first hour of service and subsequent
                charges for each additional hour thereafter. We want to ensure
                transparency in our pricing, and the final payment will be
                calculated based on the actual hours worked. Thank you for your
                understanding.
              </p>
            </div>
            ...
            <div
              className="bg-primary h-16 rounded-lg flex justify-end p-3 mt-10"
              data-aos="fade-up"
            >
              <button
                onClick={handleBooking}
                className="rounded-lg  bg-white text-primary p-2 px-5 font-semibold"
              >
                Book This Service
              </button>
            </div>
