...
function WorkerChat(props: {conversationData: IConversation}) {
  ...
  return (
<div className="bg-tertiary rounded-xl h-[540px] relative" style={{ overflowY: 'scroll', msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
        <div className="sticky top-0 z-10 bg-tertiary">
            <div className="flex items-center gap-5 p-3 ">
            <div className="">
                <img className="h-16 w-16 rounded-full" src={props.conversationData.user_profile} alt="" />
            </div>
